...
func (_Polygonzkevm *PolygonzkevmCaller) VERSIONBEFOREUPGRADE(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Polygonzkevm.contract.Call(opts, &out, "VERSION_BEFORE_UPGRADE")
...
//
// Solidity: function VERSION_BEFORE_UPGRADE() view returns(uint256)
func (_Polygonzkevm *PolygonzkevmSession) VERSIONBEFOREUPGRADE() (*big.Int, error) {
	return _Polygonzkevm.Contract.VERSIONBEFOREUPGRADE(&_Polygonzkevm.CallOpts)
}

// VERSIONBEFOREUPGRADE is a free data retrieval call binding the contract method 0xa42ea145.
//
// Solidity: function VERSION_BEFORE_UPGRADE() view returns(uint256)
func (_Polygonzkevm *PolygonzkevmCallerSession) VERSIONBEFOREUPGRADE() (*big.Int, error) {
	return _Polygonzkevm.Contract.VERSIONBEFOREUPGRADE(&_Polygonzkevm.CallOpts)
}
...
func (_Polygonzkevm *PolygonzkevmCaller) LastVerifiedBatchBeforeUpgrade(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Polygonzkevm.contract.Call(opts, &out, "lastVerifiedBatchBeforeUpgrade")
...
//
// Solidity: function lastVerifiedBatchBeforeUpgrade() view returns(uint256)
func (_Polygonzkevm *PolygonzkevmSession) LastVerifiedBatchBeforeUpgrade() (*big.Int, error) {
	return _Polygonzkevm.Contract.LastVerifiedBatchBeforeUpgrade(&_Polygonzkevm.CallOpts)
}

// LastVerifiedBatchBeforeUpgrade is a free data retrieval call binding the contract method 0x63568445.
//
// Solidity: function lastVerifiedBatchBeforeUpgrade() view returns(uint256)
func (_Polygonzkevm *PolygonzkevmCallerSession) LastVerifiedBatchBeforeUpgrade() (*big.Int, error) {
	return _Polygonzkevm.Contract.LastVerifiedBatchBeforeUpgrade(&_Polygonzkevm.CallOpts)
}
...
func (_Polygonzkevm *PolygonzkevmCaller) Version(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Polygonzkevm.contract.Call(opts, &out, "version")
...
//
// Solidity: function version() view returns(uint256)
func (_Polygonzkevm *PolygonzkevmSession) Version() (*big.Int, error) {
	return _Polygonzkevm.Contract.Version(&_Polygonzkevm.CallOpts)
}

// Version is a free data retrieval call binding the contract method 0x54fd4d50.
//
// Solidity: function version() view returns(uint256)
func (_Polygonzkevm *PolygonzkevmCallerSession) Version() (*big.Int, error) {
	return _Polygonzkevm.Contract.Version(&_Polygonzkevm.CallOpts)
}
...
func (_Polygonzkevm *PolygonzkevmTransactor) UpdateVersion(opts *bind.TransactOpts, _versionString string) (*types.Transaction, error) {
	return _Polygonzkevm.contract.Transact(opts, "updateVersion", _versionString)
}

// UpdateVersion is a paid mutator transaction binding the contract method 0x7240f9af.
//
// Solidity: function updateVersion(string _versionString) returns()
func (_Polygonzkevm *PolygonzkevmSession) UpdateVersion(_versionString string) (*types.Transaction, error) {
	return _Polygonzkevm.Contract.UpdateVersion(&_Polygonzkevm.TransactOpts, _versionString)
}

// UpdateVersion is a paid mutator transaction binding the contract method 0x7240f9af.
//
// Solidity: function updateVersion(string _versionString) returns()
func (_Polygonzkevm *PolygonzkevmTransactorSession) UpdateVersion(_versionString string) (*types.Transaction, error) {
	return _Polygonzkevm.Contract.UpdateVersion(&_Polygonzkevm.TransactOpts, _versionString)
}
